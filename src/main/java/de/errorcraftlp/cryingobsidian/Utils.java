...
public class Utils {
	...
	public static final String GUI_FACTORY = "de.errorcraftlp.cryingobsidian.CryingObsidianConfig$Factory";
	...
	public static void setSpawnPointAtPlayer(final World world, final EntityPlayer player) {
		...
		if(!world.isRemote) {
			...
			if(player.isInWater()) {
				...
				} catch(@SuppressWarnings("unused") final NoSuchMethodError ignored) {
